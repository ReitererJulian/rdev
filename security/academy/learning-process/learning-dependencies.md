...
The problem here is the sheer size of the information security field. As we saw in the example with programming languages, there is a lot to learn and many topics to cover.
...
The primary and most difficult objective we must overcome is the `combination` of our knowledge.
